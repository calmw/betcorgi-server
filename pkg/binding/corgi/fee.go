...
func (_Fee *FeeCaller) ADMINROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Fee.contract.Call(opts, &out, "ADMIN_ROLE")
...
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_Fee *FeeSession) ADMINROLE() ([32]byte, error) {
	return _Fee.Contract.ADMINROLE(&_Fee.CallOpts)
}

// ADMINROLE is a free data retrieval call binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_Fee *FeeCallerSession) ADMINROLE() ([32]byte, error) {
	return _Fee.Contract.ADMINROLE(&_Fee.CallOpts)
}
