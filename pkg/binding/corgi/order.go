...
// AdminSetEnv is a paid mutator transaction binding the contract method 0x9fd401e0.
//
// Solidity: function admin_set_env(address gameAddress_, address autoBetAddress_, address gameCategoryAddress_) returns()
func (_Order *OrderTransactor) AdminSetEnv(opts *bind.TransactOpts, gameAddress_ common.Address, autoBetAddress_ common.Address, gameCategoryAddress_ common.Address) (*types.Transaction, error) {
	return _Order.contract.Transact(opts, "admin_set_env", gameAddress_, autoBetAddress_, gameCategoryAddress_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x9fd401e0.
//
// Solidity: function admin_set_env(address gameAddress_, address autoBetAddress_, address gameCategoryAddress_) returns()
func (_Order *OrderSession) AdminSetEnv(gameAddress_ common.Address, autoBetAddress_ common.Address, gameCategoryAddress_ common.Address) (*types.Transaction, error) {
	return _Order.Contract.AdminSetEnv(&_Order.TransactOpts, gameAddress_, autoBetAddress_, gameCategoryAddress_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x9fd401e0.
//
// Solidity: function admin_set_env(address gameAddress_, address autoBetAddress_, address gameCategoryAddress_) returns()
func (_Order *OrderTransactorSession) AdminSetEnv(gameAddress_ common.Address, autoBetAddress_ common.Address, gameCategoryAddress_ common.Address) (*types.Transaction, error) {
	return _Order.Contract.AdminSetEnv(&_Order.TransactOpts, gameAddress_, autoBetAddress_, gameCategoryAddress_)
}
...
//
// Solidity: function draw(uint256 gameId_, uint256 autoId_, uint256 orderId_, string seed_, uint256 amount_, bool hashExpired_) returns()
func (_Order *OrderTransactor) Draw(opts *bind.TransactOpts, gameId_ *big.Int, autoId_ *big.Int, orderId_ *big.Int, seed_ string, amount_ *big.Int, hashExpired_ bool) (*types.Transaction, error) {
	return _Order.contract.Transact(opts, "draw", gameId_, autoId_, orderId_, seed_, amount_, hashExpired_)
}

// Draw is a paid mutator transaction binding the contract method 0xd9b849fa.
//
// Solidity: function draw(uint256 gameId_, uint256 autoId_, uint256 orderId_, string seed_, uint256 amount_, bool hashExpired_) returns()
func (_Order *OrderSession) Draw(gameId_ *big.Int, autoId_ *big.Int, orderId_ *big.Int, seed_ string, amount_ *big.Int, hashExpired_ bool) (*types.Transaction, error) {
	return _Order.Contract.Draw(&_Order.TransactOpts, gameId_, autoId_, orderId_, seed_, amount_, hashExpired_)
}

// Draw is a paid mutator transaction binding the contract method 0xd9b849fa.
//
// Solidity: function draw(uint256 gameId_, uint256 autoId_, uint256 orderId_, string seed_, uint256 amount_, bool hashExpired_) returns()
func (_Order *OrderTransactorSession) Draw(gameId_ *big.Int, autoId_ *big.Int, orderId_ *big.Int, seed_ string, amount_ *big.Int, hashExpired_ bool) (*types.Transaction, error) {
	return _Order.Contract.Draw(&_Order.TransactOpts, gameId_, autoId_, orderId_, seed_, amount_, hashExpired_)
}
