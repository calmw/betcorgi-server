...
func (_GameCategory *GameCategoryCaller) ADMINROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _GameCategory.contract.Call(opts, &out, "ADMIN_ROLE")
...
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_GameCategory *GameCategorySession) ADMINROLE() ([32]byte, error) {
	return _GameCategory.Contract.ADMINROLE(&_GameCategory.CallOpts)
}

// ADMINROLE is a free data retrieval call binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_GameCategory *GameCategoryCallerSession) ADMINROLE() ([32]byte, error) {
	return _GameCategory.Contract.ADMINROLE(&_GameCategory.CallOpts)
}
