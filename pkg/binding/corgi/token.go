...
func (_Token *TokenCaller) ADMINROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "ADMIN_ROLE")
...
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_Token *TokenSession) ADMINROLE() ([32]byte, error) {
	return _Token.Contract.ADMINROLE(&_Token.CallOpts)
}

// ADMINROLE is a free data retrieval call binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (_Token *TokenCallerSession) ADMINROLE() ([32]byte, error) {
	return _Token.Contract.ADMINROLE(&_Token.CallOpts)
}
