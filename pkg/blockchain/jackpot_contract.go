...
//	c.AdminSetEnv(big.NewInt(1e6), big.NewInt(10e6), true)
//	c.AddAccess()
//}
//
...
//}
//
//func (c Jackpot) AdminSetEnv(addAmount, minOrderAmount *big.Int, jackpotSwitch bool) {
//	var res *types.Transaction
//	for {
//		txOpts, err := GetAuth(c.Cli)
//		if err != nil {
...
//			return
//		}
//		res, err = c.Contract.AdminSetEnv(txOpts, addAmount, minOrderAmount, common.HexToAddress(ChainConfig.USDTAddress), common.HexToAddress(ChainConfig.TokenContractAddress), jackpotSwitch)
//		if err == nil {
//			break
//		}
//		fmt.Println(err)
